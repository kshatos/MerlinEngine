...
namespace Merlin
{
    ...
    void OpenGLTexture2D::Init(const unsigned char* data,
                               uint32_t width,
                               uint32_t height,
                               ...
                               Texture2DProperties props)
    {
        ...
        glTexParameteri(GL_TEXTURE_2D,
                        GL_TEXTURE_WRAP_S,
                        GetOpenGLWrapMode(props.s_wrap_mode));
        glTexParameteri(GL_TEXTURE_2D,
                        GL_TEXTURE_WRAP_T,
                        GetOpenGLWrapMode(props.t_wrap_mode));
    ...
    OpenGLTexture2D::OpenGLTexture2D(Texture2DData texture_data,
                                     Texture2DProperties props)
    {
        Init(texture_data.GetDataPointer(),
    ...
    void OpenGLTexture2D::Bind(uint32_t slot) { glBindTextureUnit(slot, m_id); }
