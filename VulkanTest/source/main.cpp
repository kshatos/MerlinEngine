...
public:
    virtual void OnAttach() override
    {
        ...
        BufferLayout layout{{ElementDataType::Float3, "Pos"}};

        m_meshBuffer =
            Renderer::CreateMeshBuffer(vertices.data(),
    ...
    virtual void OnUpdate(float time_step) override { ImGui::ShowDemoWindow(); }
